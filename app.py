...
PROJECTS = {
    ...
    'steel-dashboard': {'name': 'Steel Fabrication Dashboard', 'sector': 'Trades Dashboards', 'status': 'Rebuilding', 'tagline': 'Shop management for steel fabrication', 'description': 'Originally built as an 8-container Docker system for a steel fabrication shop. Currently being redesigned and tested as part of the Granite dashboard series with the same architecture as the completed Landscape Dashboard.', 'stats': {}, 'tech': ['Python', 'Flask', 'Docker', 'SQLite'], 'features': ['Job tracking', 'Material inventory', 'Shop scheduling', 'Client billing'], 'video': None, 'priority': 'high'},
